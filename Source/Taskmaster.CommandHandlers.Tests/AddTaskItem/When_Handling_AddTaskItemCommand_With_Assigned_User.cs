...
namespace Taskmaster.CommandHandlers.Tests.AddTaskItem
{
    ...
    public class When_Handling_AddTaskItemCommand_With_Assigned_User : WithCommandHandlerFor<AddTaskItemCommand>
    {
        ...
        {
            return new AddTaskItemCommand(_authenticatedUserId, _taskItemAggregateId, "Test title", "Test details", _assignedUserAggregateId);
        }
        ...
        {
            Assert.AreEqual(_assignedUserAggregateId, Event<TaskItemAddedEvent>(0).AssignedUserAggregateId);
        }

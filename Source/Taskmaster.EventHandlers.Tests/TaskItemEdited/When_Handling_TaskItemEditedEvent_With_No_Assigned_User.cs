...
{
    [TestClass]
    public class When_Handling_TaskItemEditedEvent_With_No_Assigned_User : WithEventHandlerFor<TaskItemEditedEvent>
    {
        ...
        {
            return new TaskItemEditedEvent(_taskItemAggregateId, "Changed title", "Changed details", null, _createdByUserId);
        }
        ...
        {
            Assert.AreEqual(null, _taskItem.AssignedToUserId);
        }

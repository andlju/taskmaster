...
{
    [TestClass]
    public class When_Handling_TaskItemAddedEvent_With_No_Assigned_User : WithEventHandlerFor<TaskItemAddedEvent>
    {
        ...
        {
            return new TaskItemAddedEvent(_taskItemAggregateId, "Test title", "Test details", null, _createdByUserId);
        }
        ...
        {
            Assert.AreEqual(null, _storedTaskItem.AssignedToUserId);
        }
